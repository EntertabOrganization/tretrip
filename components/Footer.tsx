...
export default function Footer() {
    ...
    return (
        <footer className="bg-brand-primary text-white pt-10 md:pt-16 pb-6 md:pb-8">
            <div className="max-w-[90rem] mx-auto px-4 sm:px-6 md:px-[50px]">
                <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-12 ${dir === "rtl" ? "text-right" : "text-left"}`}>
                    ...
                    <div className="space-y-4 md:space-y-5">
                        ...
                        <p className="text-white/70 leading-relaxed font-poppins text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] italic">
                            {t("footer.tagline")}
                        </p>
                    </div>
                    ...
                    {/* Services */}
                    <div>
                        <h4 className="text-[14px] sm:text-[16px] md:text-[17px] lg:text-[18px] font-semibold mb-4 md:mb-6 font-space text-brand-accent">{t("footer.quickLinks")}</h4>
                    ...
                    {/* Company */}
                    <div>
                        <h4 className="text-[14px] sm:text-[16px] md:text-[17px] lg:text-[18px] font-semibold mb-4 md:mb-6 font-space text-brand-accent">{t("footer.company")}</h4>
                        <ul className="space-y-2 md:space-y-3 text-white/80 font-poppins text-[13px] md:text-[14px] lg:text-[15px]">
                    ...
                    {/* Contact Us */}
                    <div>
                        <h4 className="text-[14px] sm:text-[16px] md:text-[17px] lg:text-[18px] font-semibold mb-4 md:mb-6 font-space text-brand-accent">{t("footer.contactUs")}</h4>
                        <div className="space-y-3 md:space-y-5">
                            <a href="tel:+12029912999" className="flex items-start gap-2 md:gap-3 text-white/80 hover:text-white transition-colors font-poppins text-[12px] sm:text-[13px] md:text-[14px]">
                                <Phone size={16} className="flex-shrink-0 mt-0.5" />
                                <div>
                                    <span className="font-semibold text-white block">{t("footer.phone")}</span>
                            ...
                            <a href="https://api.whatsapp.com/send?phone=12027706480" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 text-white/80 hover:text-white transition-colors font-poppins text-[14px]">
                                ...
                                <div>
                                    <span className="font-semibold text-white block">{t("footer.whatsapp")}</span>
                            ...
                            <a href="mailto:reservations@tretrip.com" className="flex items-start gap-3 text-white/80 hover:text-white transition-colors font-poppins text-[14px]">
                                ...
                                <div>
                                    <span className="font-semibold text-white block">{t("footer.email")}</span>
                ...
                <div className="flex justify-center gap-3 md:gap-4 mb-6 md:mb-8">
                    <a href="https://www.facebook.com/profile.php?id=100063837548951" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="md:w-6 md:h-6"><path d="M24 12.0301C24 5.38947 18.624 0 12 0C5.376 0 0 5.38947 0 12.0301C0 17.8526 4.128 22.7008 9.6 23.8195V15.6391H7.2V12.0301H9.6V9.02256C9.6 6.70075 11.484 4.81203 13.8 4.81203H16.8V8.42105H14.4C13.74 8.42105 13.2 8.96241 13.2 9.62406V12.0301H16.8V15.6391H13.2V24C19.26 23.3985 24 18.2737 24 12.0301Z" /></svg>
                    </a>
                ...
                {/* Copyright */}
                <div className="pt-4 md:pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-3 md:gap-0 text-[11px] sm:text-[12px] md:text-[13px] font-poppins text-white/60 italic">
                    <p>Copyright © {new Date().getFullYear()} TreTrip {t("footer.copyright")}</p>
                    <p>{t("footer.designedBy")} <Link href="https://entertab.net/" target="_blank" className="text-brand-accent hover:text-white transition-colors">Entertab</Link></p>
                </div>
            </div>
        </footer>
    );
