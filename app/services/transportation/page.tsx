                            ...
                            icon: (
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <g transform="translate(17, 22)">
                                        <path d="M26.5 16H29.5C30.4 16 31 15.4 31 14.5V10C31 8.65 29.95 7.45 28.75 7.15C26.05 6.4 22 5.5 22 5.5C22 5.5 20.05 3.4 18.7 2.05C17.95 1.45 17.05 1 16 1H5.5C4.6 1 3.85 1.6 3.4 2.35L1.3 6.7C1.10137 7.27934 1 7.88756 1 8.5V14.5C1 15.4 1.6 16 2.5 16H5.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M8.5 19C10.1569 19 11.5 17.6569 11.5 16C11.5 14.3431 10.1569 13 8.5 13C6.84315 13 5.5 14.3431 5.5 16C5.5 17.6569 6.84315 19 8.5 19Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M11.5 16H20.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M23.5 19C25.1569 19 26.5 17.6569 26.5 16C26.5 14.3431 25.1569 13 23.5 13C21.8431 13 20.5 14.3431 20.5 16C20.5 17.6569 21.8431 19 23.5 19Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                </svg>
                            ),
                            title: "Modern Fleet",
