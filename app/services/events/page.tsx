        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="pt-20">
                ...
                <section
                    ...
                    style={{ backgroundImage: "url('/Services/Event.png')", height: "70vh" }}
                >
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-gray-600">
                                    <li className="flex items-center gap-3">
                                        <span className="text-brand-primary font-bold">✓</span> Event planning & coordination
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <span className="text-brand-primary font-bold">✓</span> Venue & catering selection
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <span className="text-brand-primary font-bold">✓</span> Entertainment & audiovisuals
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <span className="text-brand-primary font-bold">✓</span> Logistics & on-day management
                                    </li>
                                </ul>
                            </div>
                            <div className="bg-gray-100 rounded-lg h-96 flex items-center justify-center">
                                <p className="text-gray-400">Event Service Image</p>
                            </div>
                        </div>
                    </div>
                </section>
